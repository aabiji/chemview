...
@group(0) @binding(2)
var<uniform> object_rotation: mat4x4<f32>;
@group(0) @binding(3)
...
@vertex
fn vertex_shader(@location(0) position: vec4<f32>, @location(1) normal: vec4<f32>, @builtin(instance_index) instance_index: u32) -> VertexOutput {
